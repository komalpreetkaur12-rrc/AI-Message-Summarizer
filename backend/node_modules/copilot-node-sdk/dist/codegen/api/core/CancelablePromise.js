...
export class CancelablePromise {
    ...
    __classPrivateFieldSet(
      ...
      new Promise((resolve, reject) => {
        ...
        const onResolve = (value) => {
          var _a;
          if (
            __classPrivateFieldGet(this, _CancelablePromise_isResolved, 'f') ||
            __classPrivateFieldGet(this, _CancelablePromise_isRejected, 'f') ||
  ...
  get [((_CancelablePromise_isResolved = new WeakMap()),
  (_CancelablePromise_isRejected = new WeakMap()),
  ...
  cancel() {
    ...
    (_a = __classPrivateFieldGet(this, _CancelablePromise_reject, 'f')) ===
      null || _a === void 0
      ? void 0
      : _a.call(this, new CancelError('Request aborted'));
  }
  get isCancelled() {
