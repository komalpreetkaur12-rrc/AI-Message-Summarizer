...
const getUrl = (config, options) => {
  ...
  const path = options.url
    ...
    .replace(/{(.*?)}/g, (substring, group) => {
      var _a;
      if (
        (_a = options.path) === null || _a === void 0
          ? void 0
          : _a.hasOwnProperty(group)
      ) {
...
export const getHeaders = (config, options) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const headers = Object.entries(
      Object.assign(
        Object.assign({ Accept: 'application/json' }, additionalHeaders),
        options.headers,
      ),
    )
      .filter(([_, value]) => isDefined(value))
      .reduce(
        (headers, [key, value]) =>
          Object.assign(Object.assign({}, headers), { [key]: String(value) }),
        {},
      );
...
export const getRequestBody = (options) => {
  ...
  if (options.body !== undefined) {
    if (
      (_a = options.mediaType) === null || _a === void 0
        ? void 0
        : _a.includes('/json')
    ) {
...
export const catchErrorCodes = (options, result) => {
  ...
  if (!result.ok) {
    const errorStatus =
      (_a = result.status) !== null && _a !== void 0 ? _a : 'unknown';
    const errorStatusText =
      (_b = result.statusText) !== null && _b !== void 0 ? _b : 'unknown';
    const errorBody = (() => {
      try {
      ...
      try {
        ...
        if (!onCancel.isCancelled) {
          ...
          const result = {
            ...
            body:
              responseHeader !== null && responseHeader !== void 0
                ? responseHeader
                : responseBody,
          };
